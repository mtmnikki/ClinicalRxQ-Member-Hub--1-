...
export default function Account() {
  ...
  useEffect(() => {
    if (account?.id) loadProfiles(account.id);
  }, [account?.id, loadProfiles]);
                  ...
                  profiles.map((profile) => (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-sm text-slate-500">{profile.roleType}</div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{profile.roleType}</Badge>
                      </div>
                    </div>
                  ))
                )}
